...
import { Opportunity, OpportunityStage, OpportunityPriority } from '../../../models/sales';
import { Contact } from '../../../models/sales';
import { Company } from '../../../models/sales';
import { Plus, Search, Filter, DollarSign, Calendar, User, Building } from 'lucide-react';
...
export default function OpportunitiesPage() {
  ...
  const handleEdit = (opportunity: Opportunity) => {
    ...
    setFormData({
      ...
      closeDate: opportunity.expectedCloseDate ? new Date(opportunity.expectedCloseDate).toISOString().split('T')[0] : '',
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {filteredOpportunities.length > 0 
                  ? Math.round((filteredOpportunities.filter(o => o.stage === OpportunityStage.CLOSED_WON).length / filteredOpportunities.length) * 100)
                  : 0}%
              </div>
              <p className="text-xs text-muted-foreground">
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <h3 className="font-semibold text-lg">{opportunity.name || opportunity.title}</h3>
                        ...
                        <div className="flex items-center gap-6 text-sm text-gray-500">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            {opportunity.expectedCloseDate ? new Date(opportunity.expectedCloseDate).toLocaleDateString() : 'No close date'}
                          </div>
                          <div className="flex items-center gap-1">
                          ...
                          {opportunity.contactId && (
                            <div className="flex items-center gap-1">
                              <User className="w-4 h-4" />
                              {contacts.find(c => c.id === opportunity.contactId)?.firstName} {contacts.find(c => c.id === opportunity.contactId)?.lastName}
                            </div>
                          )}
          ...
          <DialogContent className="max-w-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => setFormData({ ...formData, amount: e.target.value })}
                    placeholder="0.00"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <Label htmlFor="stage">Stage *</Label>
                  <Select value={formData.stage} onValueChange={(value: string) => setFormData({ ...formData, stage: value as OpportunityStage })}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div>
                  <Label htmlFor="priority">Priority</Label>
                  <Select value={formData.priority} onValueChange={(value: string) => setFormData({ ...formData, priority: value as OpportunityPriority })}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => setFormData({ ...formData, probability: e.target.value })}
                    placeholder="50"
                    required
                  />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => setFormData({ ...formData, closeDate: e.target.value })}
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <Select value={formData.contactId} onValueChange={(value: string) => setFormData({ ...formData, contactId: value })}>
                    <SelectTrigger>
