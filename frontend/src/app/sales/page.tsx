  ...
  const handleCreateLead = async (e: React.FormEvent) => {
    ...
    try {
      await apiService.createLead({
        ...leadFormData,
        estimatedValue: leadFormData.estimatedValue ? parseFloat(leadFormData.estimatedValue) : undefined,
  ...
  const handleCreateOpportunity = async (e: React.FormEvent) => {
    ...
    try {
      await apiService.createOpportunity({
        ...
        expectedCloseDate: opportunityFormData.expectedCloseDate || new Date().toISOString(),
        leadSource: LeadSource.WEBSITE,
        tags: []
      });
      ...
      <div className="space-y-6 p-6">
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex space-x-2">
            ...
            <Button variant="outline" onClick={() => setShowCreateOpportunityDialog(true)}>
              <Plus className="w-4 h-4 mr-2" />
              New Opportunity
            </Button>
          </div>
          ...
          <form onSubmit={handleCreateLead} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setLeadFormData({ ...leadFormData, jobTitle: e.target.value })}
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Select value={leadFormData.leadSource} onValueChange={(value) => setLeadFormData({ ...leadFormData, leadSource: value as LeadSource })}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div>
                ...
                <Select value={leadFormData.status} onValueChange={(value) => setLeadFormData({ ...leadFormData, status: value as LeadStatus })}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setLeadFormData({ ...leadFormData, expectedCloseDate: e.target.value })}
                />
              </div>
            </div>
            ...
            <div className="flex justify-end gap-2 pt-4">
              <Button type="button" variant="outline" onClick={() => setShowCreateLeadDialog(false)}>
                Cancel
              </Button>
              <Button type="submit">
                Create Lead
          ...
          <form onSubmit={handleCreateOpportunity} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setOpportunityFormData({ ...opportunityFormData, amount: e.target.value })}
                  placeholder="0.00"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <Select value={opportunityFormData.stage} onValueChange={(value) => setOpportunityFormData({ ...opportunityFormData, stage: value as OpportunityStage })}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) => setOpportunityFormData({ ...opportunityFormData, notes: e.target.value })}
                rows={3}
                placeholder="Additional notes..."
              />
            </div>
            ...
            <div className="flex justify-end gap-2 pt-4">
              <Button type="button" variant="outline" onClick={() => setShowCreateOpportunityDialog(false)}>
                Cancel
              </Button>
              <Button type="submit">
                Create Opportunity
