            ...
            {contacts.map((contact) => (
              ...
              >
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Button variant="outline" size="sm" onClick={() => handleDelete(contact)}>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-lg font-semibold">{viewingContact.firstName}</p>
                </div>

                <div>
                  <Label className="text-sm font-medium text-gray-500">Last Name</Label>
                  <p className="text-lg font-semibold">{viewingContact.lastName}</p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    {viewingContact.companyId ? 
                      companies.find(c => c.id === viewingContact.companyId)?.name || "Company ID: " + viewingContact.companyId
                      : "Not specified"
                    }
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>{viewingContact.type.charAt(0).toUpperCase() + viewingContact.type.slice(1)}</p>
                </div>

                <div>
                  <Label className="text-sm font-medium text-gray-500">Status</Label>
                  <Badge variant={viewingContact.isActive ? "default" : "secondary"}>
      ...
      <Dialog open={!!deletingContact} onOpenChange={() => setDeletingContact(null)}>
        <DialogContent className="max-w-md">
          ...
          {deletingContact && (
            <div className="space-y-4">
              <p className="text-gray-600">
                Are you sure you want to delete <strong>"{deletingContact.firstName} {deletingContact.lastName}"</strong>? 
