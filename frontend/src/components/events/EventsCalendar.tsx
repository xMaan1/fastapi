    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">View your events in calendar format</p>
        </div>
        ...
        <CardContent>
          <div className="flex flex-wrap gap-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-600">Team meetings and discussions</span>
            </div>
            <div className="flex items-center gap-2">
              <Badge className="bg-orange-100 text-orange-800">Workshop</Badge>
              <span className="text-sm text-gray-600">Training and workshops</span>
            </div>
            <div className="flex items-center gap-2">
